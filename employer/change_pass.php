...
if(isset($_POST["submit"])){
     ...
     $password=$_POST["password"];
      ...
      $sql="UPDATE `employer_reg` SET `password`='$password' WHERE employer_id=".$_SESSION["employerid"];
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <center>
						...
						<input type="reset" name="reset" id="res-1" value="Resend OTP" class="btn btn-danger">
					</center>
  </div>
</div>
