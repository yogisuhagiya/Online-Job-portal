...
if(isset($_POST["submit"])){
    ...
    move_uploaded_file($img_loc,"images/".$img_name);
     ...
     $sql="insert into `candidate_reg`(f_name,l_name,email,username,password,phone,address,city,state,pin_code,photo,status) values ('$fname','$lname','$email','$uname','$password','$phoneno','$address','$city','$state','$pincode','$img_des','accepted')";
...
<div class="banner">
     <p><a href="index.php">Home</a> | <a href="Registration.php">Registration</a> |<span> Candidate Registration</span></p>
</div>
...
<legend><center><h3 class="agileits_head">Candidate Registration</h3></center></legend>
...
<div class="form-group">
  <label class="col-md-4 control-label">User Name</label>  
   <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="uname" placeholder="User name" class="form-control" type="text" title="Enter Your User_Name Properly ex:'abc5,5abc' " required >
    </div>
  </div>
</div>
