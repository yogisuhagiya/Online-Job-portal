...
?>
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a style='background: #fff !important;' href="home.php">Home</a><i class="fa fa-angle-right"></i>Pending Employer</li>
            </ol>
	 ...
	 <th> Action </th>
					 ...
					 <?php
							...
							while($row = mysqli_fetch_array($result))
							{
								...
								echo "<td> <a style='background: #fff !important;' href = 'viewsellerinfo.php?employer_id=".$row['employer_id']."'>Active </a> </td>";
								echo "</tr>";
