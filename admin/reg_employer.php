...
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a style='background: #fff !important;' href="home.php">Home</a><i class="fa fa-angle-right"></i>Reports<i class="fa fa-angle-right"></i>Registered Sellers</li>
            </ol>
<div class="page-container">
 	    <div class="grid-form1">
			 <h3>Registered Employer</h3>
			 <?php include 'config.php';
							$str = "select * from employer_reg where status='accepted'";
                            $result = mysqli_query($con,$str);
                            $number = mysqli_num_rows($result);
                            echo"<h4 style='text-align:right'>Number of Accepted Sellers found: $number</h4>";  ?>
<hr>
	 ...
	 <th> Action </th>
					 ...
					 <?php
							...
							while($row = mysqli_fetch_array($result))
							{
								...
								echo "<td><a style='background: #fff !important;' href = 'delete_employer.php?employer_id=".$row['employer_id']."'>Deactive </a></td>";
								echo "</tr>";
